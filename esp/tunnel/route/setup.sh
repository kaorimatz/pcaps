...
ip netns exec ns1 ip xfrm policy add dir in mark 1 tmpl src 192.168.1.2 dst 192.168.1.1 proto esp spi 256 mode tunnel
ip netns exec ns1 ip xfrm policy add dir out mark 1 tmpl src 192.168.1.1 dst 192.168.1.2 proto esp spi 257 mode tunnel
ip netns exec ns2 ip xfrm policy add dir in mark 1 tmpl src 192.168.1.1 dst 192.168.1.2 proto esp spi 257 mode tunnel
ip netns exec ns2 ip xfrm policy add dir out mark 1 tmpl src 192.168.1.2 dst 192.168.1.1 proto esp spi 256 mode tunnel
