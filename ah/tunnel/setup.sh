...
ip netns exec ns1 ip xfrm policy add src 172.16.2.0/24 dst 172.16.1.0/24 dir in tmpl src 192.168.1.2 dst 192.168.1.1 proto ah spi 256 mode tunnel
ip netns exec ns1 ip xfrm policy add src 172.16.1.0/24 dst 172.16.2.0/24 dir out tmpl src 192.168.1.1 dst 192.168.1.2 proto ah spi 257 mode tunnel
ip netns exec ns2 ip xfrm policy add src 172.16.1.0/24 dst 172.16.2.0/24 dir in tmpl src 192.168.1.1 dst 192.168.1.2 proto ah spi 257 mode tunnel
ip netns exec ns2 ip xfrm policy add src 172.16.2.0/24 dst 172.16.1.0/24 dir out tmpl src 192.168.1.2 dst 192.168.1.1 proto ah spi 256 mode tunnel
