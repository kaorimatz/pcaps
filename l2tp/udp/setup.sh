...
ip netns exec ns1 ip l2tp add tunnel tunnel_id 1 peer_tunnel_id 1 encap udp udp_sport 1701 udp_dport 1701 local 192.168.1.1 remote 192.168.1.2
ip netns exec ns2 ip l2tp add tunnel tunnel_id 1 peer_tunnel_id 1 encap udp udp_sport 1701 udp_dport 1701 local 192.168.1.2 remote 192.168.1.1
